...
function LoadConfig() {
	...
	Config.PickitFiles.push("xpac.nip");
	...
	Config.AttackSkill[2] = -1; // Not used and ugly. TODO: Redo barbarian attacks.
	Config.AttackSkill[3] = -1; // Primary skill to others.
	Config.AttackSkill[4] = -1; // Not used and ugly. TODO: Redo barbarian attacks.
	Config.AttackSkill[5] = -1; // Secondary skill if monster is immune to primary.
	Config.AttackSkill[6] = -1; // Not used and ugly. TODO: Redo barbarian attacks.

	Config.BossPriority = false; // Set to true to attack Unique/SuperUnique monsters first when clearing
	Config.ClearType = 0xF; // Monster spectype to kill in level clear scripts (ie. Mausoleum).

	// Class specific config
	Config.FindItem = false; // Not implemented yet.
}